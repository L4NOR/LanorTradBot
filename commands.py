...
HELP_CATEGORIES = {
    ...
    "admin_giveaway": {
        ...
        "commands": [
            ...
            {"name": "giveaway_advanced", "usage": "!giveaway_advanced", "desc": "Créer un giveaway en mode interactif (gadvanced)"},
            {"name": "gend", "usage": "!gend [msg_id]", "desc": "Terminer un giveaway manuellement (gstop)"},
            {"name": "greroll", "usage": "!greroll <msg_id>", "desc": "Retirer un nouveau gagnant"},
            {"name": "gdelete", "usage": "!gdelete <msg_id>", "desc": "Supprimer un giveaway sans tirage (gcancel)"},
            {"name": "glist", "usage": "!glist", "desc": "Lister les giveaways (giveaways)"},
            {"name": "gstats", "usage": "!gstats", "desc": "Stats globales des giveaways/invitations"},
            {"name": "addinvites", "usage": "!addinvites @user <nb>", "desc": "Ajouter des invitations à un membre"},
            {"name": "resetinvites", "usage": "!resetinvites [@user]", "desc": "Reset les invitations (tous ou un membre)"},
        ]
    },
    "admin_community": {
        "emoji": "👥",
        "name": "Admin Communauté",
        "description": "Gestion communautaire (annonces, prédictions, countdown)",
        "color": 0x00BCD4,
        "admin": True,
        "commands": [
            {"name": "announce_chapter", "usage": "!announce_chapter", "desc": "Annoncer un chapitre (interactif)"},
            {"name": "test_announce", "usage": "!test_announce", "desc": "Tester une annonce"},
            {"name": "force_monthly_recap", "usage": "!force_monthly_recap [here|#salon]", "desc": "Forcer l'envoi du récap mensuel maintenant", "example": "`!force_monthly_recap here`"},
            {"name": "preuve_gagnant", "usage": "!preuve_gagnant @membre [message]", "desc": "DM tous les autres membres avec la preuve d'achat (image jointe)", "example": "`!preuve_gagnant @user Voici la preuve !` + image"},
            {"name": "prediction_create", "usage": "!prediction_create question | opt1 | opt2 | ...", "desc": "Créer une prédiction"},
            {"name": "prediction_resolve", "usage": "!prediction_resolve <id> <option>", "desc": "Résoudre une prédiction et distribuer les gains"},
            {"name": "prediction_cancel", "usage": "!prediction_cancel <id>", "desc": "Annuler une prédiction et rembourser"},
            {"name": "forcecountdown", "usage": "!forcecountdown", "desc": "Forcer la mise à jour du countdown sorties"},
            {"name": "challenges_force_rotate", "usage": "!challenges_force_rotate", "desc": "Forcer la rotation des défis hebdo"},
        ]
    },
    "admin_xp": {
        "emoji": "⭐",
        "name": "Admin XP / Points",
        "description": "Gestion XP, points et badges",
        "color": 0xFFD700,
        "admin": True,
        "commands": [
            {"name": "give_xp", "usage": "!give_xp @user <montant>", "desc": "Donner/retirer de l'XP (give_points, addxp)", "example": "`!give_xp @user 500`"},
            {"name": "reset_xp", "usage": "!reset_xp @user", "desc": "Réinitialiser l'XP d'un membre (reset_points)"},
            {"name": "set_xp", "usage": "!set_xp @user <montant>", "desc": "Définir les points/XP d'un membre (set_points)"},
            {"name": "add_xp_admin", "usage": "!add_xp_admin @user <nb>", "desc": "Ajouter/retirer des points (add_points_admin)"},
            {"name": "give_badge", "usage": "!give_badge @user <badge>", "desc": "Donner un badge", "example": "`!give_badge @user Lecteur`"},
            {"name": "remove_badge", "usage": "!remove_badge @user <badge>", "desc": "Retirer un badge"},
            {"name": "set_stat", "usage": "!set_stat @user <stat> <valeur>", "desc": "Définir une statistique d'un membre"},
            {"name": "check_badges", "usage": "!check_badges @user", "desc": "Vérifier et attribuer les badges mérités"},
        ]
    },
    "admin_shop": {
        "emoji": "💰",
        "name": "Admin Shop & Loterie",
        "description": "Gestion de la boutique et de la loterie",
        "color": 0x4CAF50,
        "admin": True,
        "commands": [
            {"name": "shop_add", "usage": "!shop_add", "desc": "Ajouter un item (interactif)"},
            {"name": "shop_remove", "usage": "!shop_remove <item>", "desc": "Retirer un item"},
            {"name": "give_item", "usage": "!give_item @user <item>", "desc": "Donner un item à un membre"},
            {"name": "configrole", "usage": "!configrole <item_id> @role", "desc": "Lier un rôle à un article"},
            {"name": "pending_roles", "usage": "!pending_roles", "desc": "Lister les rôles en attente d'attribution"},
            {"name": "give_role", "usage": "!give_role @user <item_id> @role", "desc": "Attribuer un rôle en attente"},
            {"name": "forcedraw", "usage": "!forcedraw", "desc": "Forcer un tirage de loterie"},
            {"name": "setjackpot", "usage": "!setjackpot <montant>", "desc": "Définir le jackpot de la loterie"},
        ]
    },
    "admin_mod": {
        "emoji": "🛡️",
        ...
        "commands": [
            ...
            {"name": "bulk_role", "usage": "!bulk_role @role @user1 ID2...", "desc": "Assigner un rôle en masse (assign_roles)"},
            {"name": "bulk_remove_role", "usage": "!bulk_remove_role @role @user1 ID2...", "desc": "Retirer un rôle en masse (remove_roles)"},
            {"name": "multi_bulk_role", "usage": "!multi_bulk_role @r1 @r2 - @user1 ID2...", "desc": "Plusieurs rôles en masse (assign_multi_roles)"},
            {"name": "multi_bulk_remove_role", "usage": "!multi_bulk_remove_role @r1 @r2 - @user1 ID2...", "desc": "Retirer plusieurs rôles (remove_multi_roles)"},
            {"name": "bulk_role_channel", "usage": "!bulk_role_channel @role ID_CANAL", "desc": "Rôle à tous les membres d'un canal"},
            {"name": "multi_bulk_role_channel", "usage": "!multi_bulk_role_channel @r1 @r2 - ID_CANAL", "desc": "Plusieurs rôles aux membres d'un canal"},
            {"name": "list_member_ids", "usage": "!list_member_ids ID_CIBLE", "desc": "Lister les IDs des membres d'un canal (get_ids)"},
            {"name": "listmember", "usage": "!listmember", "desc": "Liste paginée de tous les membres (listmembers)"},
            {"name": "set_logs", "usage": "!set_logs [#channel]", "desc": "Définir le canal d'audit/logs"},
        ]
    },
    "admin_minigames": {
        "emoji": "👹",
        "name": "Admin Mini-jeux & Boss",
        "description": "Gestion des boss communautaires",
        "color": 0xC0392B,
        "admin": True,
        "commands": [
            {"name": "boss_spawn", "usage": "!boss_spawn [boss_id]", "desc": "Faire apparaître un boss (spawn_boss)"},
            {"name": "boss_rotate", "usage": "!boss_rotate", "desc": "Terminer le boss courant et spawn le suivant"},
            {"name": "boss_auto", "usage": "!boss_auto [on|off]", "desc": "Activer/désactiver la rotation auto mensuelle"},
            {"name": "boss_end", "usage": "!boss_end", "desc": "Terminer le boss courant de force"},
        ]
    },
    "admin_roles": {
        "emoji": "🎭",
        "name": "Admin Rôles auto-attribués",
        "description": "Système de sélection de rôles (manga / réseaux / communauté)",
        "color": 0x16A085,
        "admin": True,
        "commands": [
            {"name": "setup_roles", "usage": "!setup_roles [#salon]", "desc": "Configurer le panneau de sélection de rôles"},
            {"name": "sync_roles", "usage": "!sync_roles", "desc": "Vérifier et lister les rôles manquants"},
            {"name": "roles_stats", "usage": "!roles_stats", "desc": "Statistiques d'attribution des rôles"},
        ]
    },
    "admin_data": {
        "emoji": "💾",
        ...
        "commands": [
            ...
            {"name": "data_list", "usage": "!data_list", "desc": "Liste des modules de données"},
            {"name": "backup", "usage": "!backup", "desc": "Sauvegarde + export complet en ZIP"},
        ]
    },
    "admin_polls": {
        "emoji": "📊",
        ...
        "admin": True,
        "commands": [
            {"name": "poll_close", "usage": "!poll_close <id>", "desc": "Fermer un sondage (close_poll, endpoll)"},
            {"name": "poll_delete", "usage": "!poll_delete <id>", "desc": "Supprimer un sondage (delete_poll)"},
        ]
    },
    "admin_tickets": {
        "emoji": "📩",
