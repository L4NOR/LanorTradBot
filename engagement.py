...
QUIZ_POOL = [
    ...
    {"manga": "Tokyo Underworld", "q": "Dans quel univers se déroule Tokyo Underworld ?",
     "options": ["Une école de magie", "Les bas-fonds de Tokyo", "Une station spatiale", "L'époque Edo"], "answer": 1},
    {"manga": "Tokyo Underworld", "q": "Quel est le thème central du manga ?",
     "options": ["Le sport", "La gastronomie", "Le crime organisé", "L'astronomie"], "answer": 2},
    # Catenaccio
